...
const EXCEL_PATHS = {
  male: path.join(__dirname, "data", "students.xlsx"),
  female: path.join(__dirname, "data", "studentsg.xlsx")
};

function loadStudentsFromExcelBySection(section = "male") {
  const EXCEL_PATH = EXCEL_PATHS[section] || EXCEL_PATHS.male;
